...
class ContributionSummaryMapperTest {
    ...
    void givenAValidContributionsSummaryDTO_whenMapIsInvoked_thenReturnContributionsSummary() {
        ...
        softly.assertThat(contributionSummary.getMonthlyContributions())
                .isEqualTo(contributionsSummaryDTO.getMonthlyContributions());
        softly.assertThat(contributionSummary.getUpfrontContributions())
                .isEqualTo(contributionsSummaryDTO.getUpfrontContributions());
        ...
        softly.assertThat(contributionSummary.getEffectiveDate())
                .isEqualTo(convertDateToDateTime(contributionsSummaryDTO.getEffectiveDate()));
        softly.assertThat(contributionSummary.getCalcDate())
                .isEqualTo(convertDateToDateTime(contributionsSummaryDTO.getCalcDate()));
        softly.assertAll();
    }
}
