...
class ContributionResponseDTOBuilderTest {
    ...
    void givenAValidCorrespondenceRuleAndTemplateInfo_whenMapIsInvoked_thenContributionResponseDTOIsMappedCorrectly() {
        ...
        ContributionResponseDTO contributionResponse =
        ...
        softly.assertThat(contributionResponse.getCorrespondenceType())
                .isEqualTo(correspondence.getCotyCorrespondenceType());
        softly.assertThat(contributionResponse.getUpliftCote()).isEqualTo(correspondence.getUpliftCoteId());
        softly.assertThat(contributionResponse.getReassessmentCoteId())
                .isEqualTo(correspondence.getReassessmentCoteId());
        softly.assertThat(contributionResponse.getCorrespondenceTypeDesc())
                .isEqualTo(CorrespondenceType.getFrom(correspondence.getCotyCorrespondenceType())
                        .getDescription());
    ...
    void givenEmptyCorrespondence_whenMapIsInvoked_thenContributionResponseDTOIsMappedCorrectly() {
        CorrespondenceRuleAndTemplateInfo correspondence =
                TestModelDataBuilder.getEmptyCorrespondenceRuleAndTemplateInfo();
        ContributionResponseDTO contributionResponse =
                ContributionResponseDTO.builder().build();
        ContributionResponseDTOMapper contributionResponseDTOMapper = new ContributionResponseDTOMapper();
        contributionResponseDTOMapper.map(correspondence, contributionResponse);
