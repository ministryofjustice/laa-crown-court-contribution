...
class MaatCalculateContributionResponseMapperTest {
    ...
    void givenAValidContributionResult_whenMapIsInvoked_thenReturnApiMaatCalculateContributionResponse() {
        ...
        ApiMaatCalculateContributionResponse maatCalculateContributionResponse = maatCalculateContributionResponseMapper.map(contributionResult, null, ContributionResponseDTO.builder().build());
        softly.assertThat(maatCalculateContributionResponse.getMonthlyContributions()).isEqualTo(contributionResult.monthlyAmount());
        softly.assertThat(maatCalculateContributionResponse.getUpfrontContributions()).isEqualTo(contributionResult.upfrontAmount());
        ...
        softly.assertThat(maatCalculateContributionResponse.getTotalMonths()).isEqualTo(contributionResult.totalMonths());
        softly.assertThat(maatCalculateContributionResponse.getContributionCap()).isEqualTo(contributionResult.contributionCap());
        softly.assertThat(maatCalculateContributionResponse.getEffectiveDate()).isEqualTo(convertDateToDateTime(contributionResult.effectiveDate()));
        ...
        softly.assertThat(maatCalculateContributionResponse.getProcessActivity()).isNull();
        softly.assertAll();
    }

    @Test
    void givenContributionResultWithUplift_whenMapIsInvoked_thenUpliftIsMappedCorrectly() {
        ContributionResult contributionResult = ContributionResult.builder().isUplift(true).build();
        MaatCalculateContributionResponseMapper maatCalculateContributionResponseMapper = new MaatCalculateContributionResponseMapper();
        ApiMaatCalculateContributionResponse maatCalculateContributionResponse = maatCalculateContributionResponseMapper.map(contributionResult, null, ContributionResponseDTO.builder().build());
    ...
    void givenAValidateContributionCreated_whenMapIsInvoked_thenCreateContributionFieldsMappedCorrectly() {
        ...
        ContributionResponseDTO contributionResponseDTO = ContributionResponseDTO.builder().id(1).build();
        MaatCalculateContributionResponseMapper maatCalculateContributionResponseMapper = new MaatCalculateContributionResponseMapper();
        ApiMaatCalculateContributionResponse maatCalculateContributionResponse = maatCalculateContributionResponseMapper.map(contributionResult, createdContribution, contributionResponseDTO);

        softly.assertThat(maatCalculateContributionResponse.getContributionId()).isEqualTo(createdContribution.getId());
        softly.assertThat(maatCalculateContributionResponse.getCalcDate()).isEqualTo(convertDateToDateTime(createdContribution.getCalcDate()));
        softly.assertThat(maatCalculateContributionResponse.getProcessActivity()).isTrue();
        softly.assertAll();
    }
    ...
    void givenValidContribution_whenMapIsInvoked_thenReturnApiMaatCalculateContributionResponse() {
        ...
        softly.assertThat(response.getEffectiveDate()).isEqualTo(convertDateToDateTime(contribution.getEffectiveDate()));
