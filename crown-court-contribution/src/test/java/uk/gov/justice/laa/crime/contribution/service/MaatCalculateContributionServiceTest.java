...
class MaatCalculateContributionServiceTest {
    ...
    void givenAValidCaseType_whenCalculateContributionIsInvoked_thenShouldNotCalledCalculateContribution() {
        ...
        maatCalculateContributionService.calculateContribution(CalculateContributionDTO.builder()
                .repId(120)
    ...
    @Test
    void
            givenValidContributionAndShouldCreateContributionIsTrue_whenCreateContributionsIsInvoked_thenContributionIsReturned() {
        ...
        verify(maatCourtDataService, times(1)).createContribution(any(CreateContributionRequest.class));
        assertThat(result).isNotNull();
    }

    @Test
    void
            givenValidContributionAndShouldCreateContributionIsFalse_whenCreateContributionsIsInvoked_thenNullIsReturned() {
        when(compareContributionService.shouldCreateContribution(
                        any(CalculateContributionDTO.class), any(ContributionResult.class)))
                .thenReturn(false);
    ...
    @Test
    void
            givenNoCommittalDateAndPassportAssessmentDate_whenGetEffectiveDateIsInvoked_thenPassportAssessmentDateIsReturned() {
        ...
        CalculateContributionDTO calculateContributionDTO = CalculateContributionDTO.builder()
                .assessments(List.of(
                        new ApiAssessment().withAssessmentType(PASSPORT).withAssessmentDate(passportAssessmentDate)))
                .build();
        LocalDate effectiveDate = MaatCalculateContributionService.getEffectiveDate(calculateContributionDTO);

        softly.assertThat(effectiveDate.getMonth()).isEqualTo(passportAssessmentDate.getMonth());
        softly.assertThat(effectiveDate.getYear()).isEqualTo(passportAssessmentDate.getYear());
        softly.assertThat(effectiveDate.getDayOfMonth()).isEqualTo(passportAssessmentDate.getDayOfMonth());
    }

    @Test
    void
            givenNoCommittalDateAndFullMeansAssessmentDate_whenGetEffectiveDateIsInvoked_thenFullMeansAssessmentDateIsReturned() {
        LocalDateTime fullMeansAssessmentDate = LocalDateTime.of(2023, 8, 28, 12, 12, 12);
        CalculateContributionDTO calculateContributionDTO = CalculateContributionDTO.builder()
                .assessments(List.of(
                        new ApiAssessment().withAssessmentType(FULL).withAssessmentDate(fullMeansAssessmentDate)))
                .build();
        LocalDate effectiveDate = MaatCalculateContributionService.getEffectiveDate(calculateContributionDTO);

        softly.assertThat(effectiveDate.getMonth()).isEqualTo(fullMeansAssessmentDate.getMonth());
        softly.assertThat(effectiveDate.getYear()).isEqualTo(fullMeansAssessmentDate.getYear());
        softly.assertThat(effectiveDate.getDayOfMonth()).isEqualTo(fullMeansAssessmentDate.getDayOfMonth());
    }

    @Test
    void
            givenNoCommittalDateAndInitMeansAssessmentDate_whenGetEffectiveDateIsInvoked_thenInitMeansAssessmentDateIsReturned() {
        LocalDateTime initMeansAssessmentDate = LocalDateTime.of(2023, 8, 28, 12, 12, 12);
        CalculateContributionDTO calculateContributionDTO = CalculateContributionDTO.builder()
                .assessments(List.of(
                        new ApiAssessment().withAssessmentType(INIT).withAssessmentDate(initMeansAssessmentDate)))
                .build();
        LocalDate effectiveDate = MaatCalculateContributionService.getEffectiveDate(calculateContributionDTO);

        softly.assertThat(effectiveDate.getMonth()).isEqualTo(initMeansAssessmentDate.getMonth());
        softly.assertThat(effectiveDate.getYear()).isEqualTo(initMeansAssessmentDate.getYear());
        softly.assertThat(effectiveDate.getDayOfMonth()).isEqualTo(initMeansAssessmentDate.getDayOfMonth());
    }
    ...
    void givenPassportNewWorkReason_whenGetNewWorkReasonIsInvoked_thenPassportNewWorkReasonIsReturned() {
        CalculateContributionDTO calculateContributionDTO = CalculateContributionDTO.builder()
                .assessments(
                        List.of(new ApiAssessment().withAssessmentType(PASSPORT).withNewWorkReason(NewWorkReason.INF)))
                .build();
    ...
    void givenInitialNewWorkReason_whenGetNewWorkReasonIsInvoked_thenInitialNewWorkReasonIsReturned() {
        CalculateContributionDTO calculateContributionDTO = CalculateContributionDTO.builder()
                .assessments(
                        List.of(new ApiAssessment().withAssessmentType(INIT).withNewWorkReason(NewWorkReason.NEW)))
                .build();
    ...
    void givenFullNewWorkReason_whenGetNewWorkReasonIsInvoked_thenNullIsReturned() {
        CalculateContributionDTO calculateContributionDTO = CalculateContributionDTO.builder()
                .assessments(
                        List.of(new ApiAssessment().withAssessmentType(FULL).withNewWorkReason(NewWorkReason.NEW)))
                .build();
    ...
    void givenContributionDateNotNull_whenGetEffectiveDateByNewWorkReasonIsInvoked_thenContributionDateIsReturned() {
        ...
        String effectiveDate =
                MaatCalculateContributionService.getEffectiveDateByNewWorkReason(calculateContributionDTO, null, null);
    ...
    void givenNewWorkReasonAsFMA_whenGetEffectiveDateByNewWorkReasonIsInvoked_thenAssessmentDateIsReturned() {
        CalculateContributionDTO calculateContributionDTO = CalculateContributionDTO.builder()
                .assessments(
                        List.of(new ApiAssessment().withAssessmentType(PASSPORT).withNewWorkReason(NewWorkReason.FMA)))
                .build();
        LocalDate assessmentDate = LocalDate.now();
        String effectiveDate = MaatCalculateContributionService.getEffectiveDateByNewWorkReason(
                calculateContributionDTO, null, assessmentDate);
    ...
    @Test
    void
            givenNewWorkReasonAsPAIAndCurrentMonthlyContributionsAreSmallerThanNewMonthlyContributions_whenGetEffectiveDateByNewWorkReasonIsInvoked_thenAssessmentEffectiveDateIsReturned() {
        ...
        CalculateContributionDTO calculateContributionDTO = CalculateContributionDTO.builder()
                .assessments(
                        List.of(new ApiAssessment().withAssessmentType(PASSPORT).withNewWorkReason(NewWorkReason.PAI)))
        ...
        assertThat(actual).isEqualTo(assessmentDate.toString());
    }

    @Test
    void
            givenNewWorkReasonAsPAIAndCurrentMonthlyContributionsAreEqualToNewMonthlyContributions_whenGetEffectiveDateByNewWorkReasonIsInvoked_thenContributionEffectiveDateIsReturned() {
        LocalDate effectiveDate = LocalDate.now();
        CalculateContributionDTO calculateContributionDTO = CalculateContributionDTO.builder()
                .assessments(
                        List.of(new ApiAssessment().withAssessmentType(PASSPORT).withNewWorkReason(NewWorkReason.PAI)))
        ...
        assertThat(actual).isEqualTo(effectiveDate.toString());
    }

    @Test
    void
            givenNewWorkReasonAsPAIAndCurrentMonthlyContributionsAreGreaterThanNewMonthlyContributions_whenGetEffectiveDateByNewWorkReasonIsInvoked_thenContributionEffectiveDateIsReturned() {
        LocalDate assessmentDate = LocalDate.now();
    ...
    @Test
    void
            givenNewWorkReasonAsPAIAndCurrentMonthlyContributionsIsNull_whenGetEffectiveDateByNewWorkReasonIsInvoked_thenAssessmentEffectiveDateIsReturned() {
        LocalDate assessmentDate = LocalDate.now();
    ...
    @Test
    void
            givenNewWorkReasonAsPAIAndNewMonthlyContributionsIsNull_whenGetEffectiveDateByNewWorkReasonIsInvoked_thenAssessmentEffectiveDateIsReturned() {
        LocalDate assessmentDate = LocalDate.now();
    ...
    @Test
    void
            givenAValidAnnualIncomeAfterMagHardship_whenGetAnnualDisposableIncomeIsInvoked_thenAnnualIncomeAfterMagHardshipIsReturned() {
    ...
    void givenNoIncome_whenGetAnnualDisposableIncomeIsInvoked_thenZeroIsReturned() {
        BigDecimal actual = MaatCalculateContributionService.getAnnualDisposableIncome(
                CalculateContributionDTO.builder().build());
    ...
    void givenValidVariationAmount_whenCalculateVariationAmountIsInvoked_thenVariationAmountIsReturned() {
        ApiCalculateHardshipByDetailResponse apiCalculateHardshipByDetailResponse =
                new ApiCalculateHardshipByDetailResponse().withHardshipSummary(BigDecimal.TEN);
        ...
        BigDecimal variationAmount =
                maatCalculateContributionService.calculateVariationAmount(TestModelDataBuilder.REP_ID);
    ...
    @Test
    void
            givenCalcContributionsWithResultTypeINELAndBasedOnMeans_whenCalcContributionsIsInvoked_validResponseIsReturned() {
    ...
    void givenUpliftCoteNotNullAndCalcContributionsAsN_whenCalcContributionsIsInvoked_validResponseIsReturned() {
        ...
        ContributionResult expectedResult = ContributionResult.builder()
                .totalAnnualDisposableIncome(BigDecimal.ZERO)
                .monthlyAmount(BigDecimal.ZERO)
                .isUplift(false)
                .effectiveDate(COMMITTAL_DATE)
    ...
    void givenUpliftCoteNotNullAndUpliftAppliedIsPresent_whenCalcContributionsIsInvoked_validResponseIsReturned() {
        BigDecimal upfrontContributions = BigDecimal.valueOf(25);
        CalculateContributionDTO calculateContributionDTO = TestModelDataBuilder.getContributionDTOForCalcContribs();
        calculateContributionDTO.setDateUpliftApplied(LocalDate.of(2023, 9, 9));
        calculateContributionDTO.setUpfrontContributions(upfrontContributions);
        ContributionResponseDTO contributionResponseDTO = ContributionResponseDTO.builder()
                .calcContribs(Constants.N)
                .upliftCote(1)
                .build();
        ...
        expectedResponse.setUpfrontContributions(upfrontContributions);
    ...
    void givenUpliftIsRemovedAndAnnualDisposableIncome_whenCalcContributionsIsInvoked_validResponseIsReturned() {
        ...
        BigDecimal upfrontContributions = BigDecimal.valueOf(5);
        CalculateContributionDTO calculateContributionDTO = TestModelDataBuilder.getContributionDTOForCalcContribs();
        calculateContributionDTO.setDateUpliftApplied(LocalDate.of(2023, 1, 9));
        calculateContributionDTO.setDateUpliftRemoved(LocalDate.of(2023, 2, 9));
        ...
        when(calculateContributionService.calculateContribution(any()))
                .thenReturn(TestModelDataBuilder.getCalculateContributionResponse()
                        .withMonthlyContributions(contributionCap)
                        .withBasedOn(Constants.OFFENCE_TYPE)
                        .withUpfrontContributions(upfrontContributions));
    ...
    @Test
    void
            givenDisposableIncomeAfterCrownHardship_whenCalculateAnnualDisposableIncomeIsInvoked_thenValidIncomeIsReturned() {
        CalculateContributionDTO calculateContributionDTO = CalculateContributionDTO.builder()
        ...
        BigDecimal result = maatCalculateContributionService.calculateAnnualDisposableIncome(
                calculateContributionDTO, CrownCourtOutcome.SUCCESSFUL);
    ...
    @Test
    void
            givenDisposableIncomeAfterCrownHardshipAndNoVariation_whenCalculateAnnualDisposableIncomeIsInvoked_thenValidIncomeIsReturned() {
        CalculateContributionDTO calculateContributionDTO = CalculateContributionDTO.builder()
                .disposableIncomeAfterCrownHardship(BigDecimal.TEN)
    ...
    @Test
    void
            givenTotalAnnualDisposableIncomeAndNoVariation_whenCalculateAnnualDisposableIncomeIsInvoked_thenValidIncomeIsReturned() {
        CalculateContributionDTO calculateContributionDTO = CalculateContributionDTO.builder()
                .totalAnnualDisposableIncome(BigDecimal.TEN)
                .caseType(CaseType.INDICTABLE)
                .build();
    ...
    @Test
    void
            givenNoCalculatedDisposableIncomeAndNoVariation_whenCalculateAnnualDisposableIncomeIsInvoked_thenZeroIsReturned() {
        CalculateContributionDTO calculateContributionDTO =
                CalculateContributionDTO.builder().caseType(CaseType.INDICTABLE).build();
    ...
    @Test
    void
            givenDisposableIncomeAfterMagsHardshipAndValidVariation_whenCalculateAnnualDisposableIncomeIsInvoked_thenValidIncomeIsReturned() {
        CalculateContributionDTO calculateContributionDTO = CalculateContributionDTO.builder()
        ...
        BigDecimal result =
                maatCalculateContributionService.calculateAnnualDisposableIncome(calculateContributionDTO, null);
    ...
    void givenTransferSentAndAppealCC_whenIsCreateContributionRequiredIsInvoked_FalseIsReturned() {
        CalculateContributionDTO calculateContributionDTO =
                CalculateContributionDTO.builder().caseType(CaseType.APPEAL_CC).build();
        RepOrderDTO repOrderDTO = RepOrderDTO.builder().id(1234).build();

        when(contributionService.hasApplicationStatusChanged(repOrderDTO, CaseType.APPEAL_CC, null))
                .thenReturn(false);
        when(contributionService.hasCCOutcomeChanged(repOrderDTO.getId())).thenReturn(false);
        when(contributionService.isCds15WorkAround(repOrderDTO)).thenReturn(false);

        boolean result =
                maatCalculateContributionService.isCreateContributionRequired(calculateContributionDTO, repOrderDTO);
    ...
    void givenTransferSentAndCCOutcomeChanged_whenIsCreateContributionRequiredIsInvoked_TrueIsReturned() {
        ...
        when(contributionService.hasApplicationStatusChanged(repOrderDTO, CaseType.INDICTABLE, null))
                .thenReturn(false);
        when(contributionService.hasCCOutcomeChanged(repOrderDTO.getId())).thenReturn(true);
    ...
    void givenIndictableCase_whenCalculateContributionIsInvoked_validResponseIsReturned() {
        ...
        when(maatCourtDataService.getRepOrderByRepId(null)).thenReturn(repOrderDTO);
        when(contributionService.checkContributionsCondition(any()))
                .thenReturn(ContributionResponseDTO.builder().build());

        ApiMaatCalculateContributionResponse result =
        ...
        assertThat(result).isEqualTo(maatCalculateContributionResponse);
    }

    @Test
    void givenDoContribsIsY_whenInvoked_thenDelegatesToPerformContributions() {
        RepOrderDTO repOrderDTO = RepOrderDTO.builder().id(1234).build();

        CalculateContributionDTO calculateContributionDTO = TestModelDataBuilder.getCalculateContributionDTO();

        ContributionResponseDTO contributionResponseDTO =
                ContributionResponseDTO.builder().doContribs(Constants.Y).build();

        ApiMaatCalculateContributionResponse expectedResponse = new ApiMaatCalculateContributionResponse();

        MaatCalculateContributionService spyService = Mockito.spy(maatCalculateContributionService);

        when(contributionService.checkContributionsCondition(any())).thenReturn(contributionResponseDTO);

        doReturn(expectedResponse)
                .when(spyService)
                .performContributions(
                        eq(calculateContributionDTO), eq(contributionResponseDTO), any(), eq(repOrderDTO));

        ApiMaatCalculateContributionResponse response =
                spyService.getCalculateContributionResponse(calculateContributionDTO, repOrderDTO);
    ...
    @Test
    void givenDoContribsIsN_whenInvoked_thenReturnsEmptyResponse() {
        RepOrderDTO repOrderDTO = RepOrderDTO.builder().id(1234).build();

        CalculateContributionDTO calculateContributionDTO = TestModelDataBuilder.getCalculateContributionDTO();

        ContributionResponseDTO contributionResponseDTO =
                ContributionResponseDTO.builder().doContribs(Constants.N).build();
        ...
        verify(spyService, never()).performContributions(any(), any(), any(), any());
    }

    @Test
    void
            givenAValidCalculateContributionDTO_whenGetContributionSummariesIsInvoked_thenContributionSummaryListIsReturned() {
        ...
        when(maatCourtDataService.getContributionsSummary(any())).thenReturn(contributionSummaryDTO);
    ...
    @Test
    void givenCalcContribsIsY_whenPerformContributionsInvoked_thenCalculatesContributions() {
        CalculateContributionDTO calculateContributionDTO = TestModelDataBuilder.getCalculateContributionDTO();
        calculateContributionDTO.setMonthlyContributions(BigDecimal.ZERO);

        ContributionResponseDTO contributionResponseDTO =
                ContributionResponseDTO.builder().calcContribs(Constants.Y).build();

        when(calculateContributionService.calculateContribution(any()))
                .thenReturn(new ApiCalculateContributionResponse().withMonthlyContributions(BigDecimal.TEN));

        when(maatCourtDataService.getContributionCalcParameters(anyString()))
                .thenReturn(
                        ContributionCalcParametersDTO.builder().totalMonths(2).build());

        when(maatCalculateContributionResponseMapper.map(any(), any(), any()))
                .thenReturn(new ApiMaatCalculateContributionResponse());

        maatCalculateContributionService.performContributions(
                calculateContributionDTO, contributionResponseDTO, null, null);

        verify(calculateContributionService).calculateContribution(any());
    }

    @Test
    void givenContributionResponseIdIsPresent_whenPerformContributionsInvoked_thenCalculatesContributions() {
        CalculateContributionDTO calculateContributionDTO = TestModelDataBuilder.getCalculateContributionDTO();
        calculateContributionDTO.setMonthlyContributions(BigDecimal.ZERO);
    ...
    @Test
    void givenMonthlyContributionsGreaterThanZero_whenPerformContributionsInvoked_thenCalculatesContributions() {
        CalculateContributionDTO calculateContributionDTO = TestModelDataBuilder.getCalculateContributionDTO();
        calculateContributionDTO.setMonthlyContributions(BigDecimal.TEN);
    ...
    @Test
    void givenNoCalculationTrigger_whenPerformContributionsInvoked_thenBuildsZeroContributionResult() {
        CalculateContributionDTO calculateContributionDTO = TestModelDataBuilder.getCalculateContributionDTO();
        calculateContributionDTO.setMonthlyContributions(BigDecimal.ZERO);
        ...
        verify(calculateContributionService, never()).calculateContribution(any());
    }

    @Test
    void givenFullResultIsIneligible_whenPerformContributionsInvoked_thenDoesNotCalculateContributions() {
        CalculateContributionDTO calculateContributionDTO = TestModelDataBuilder.getCalculateContributionDTO();
        calculateContributionDTO.setMonthlyContributions(BigDecimal.TEN);
        ...
        maatCalculateContributionService.performContributions(
                calculateContributionDTO, contributionResponseDTO, Constants.INEL, null);
    ...
    void givenValidContributionId_whenGetCurrentContributionIsInvoked_validResponseIsReturned() {
        ...
        when(maatCourtDataService.findContribution(any(), any()))
                .thenReturn(List.of(Contribution.builder()
                        .id(TestModelDataBuilder.CONTRIBUTION_ID)
                        .build()));
        Contribution contribution = maatCalculateContributionService.getCurrentContribution(calculateContributionDTO);
    ...
    void givenChangeInMonthlyContributions_whenVerifyAndCreateContributionsIsInvoked_thenNewContributionIsCreated() {
        ...
        Contribution contributionResponse = maatCalculateContributionService.verifyAndCreateContributions(
                calculateContributionDTO, repOrderDTO, contributionResult);
    ...
    @Test
    void
            givenNoChangeInMonthlyContributionsOrEffectiveDate_whenVerifyAndCreateContributionsIsInvoked_thenNoContributionIsCreated() {
        CalculateContributionDTO calculateContributionDTO = TestModelDataBuilder.getCalculateContributionDTO();
        calculateContributionDTO.setMonthlyContributions(BigDecimal.valueOf(250.00));
        ContributionResult contributionResult = TestModelDataBuilder.getContributionResult();

        Contribution contributionResponse = maatCalculateContributionService.verifyAndCreateContributions(
                calculateContributionDTO, null, contributionResult);
