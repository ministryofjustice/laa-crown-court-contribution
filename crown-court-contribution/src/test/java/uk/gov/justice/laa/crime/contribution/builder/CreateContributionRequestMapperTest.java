...
class CreateContributionRequestMapperTest {
    ...
    void givenAValidContributionDTO_whenMapIsInvoked_thenReturnCreateContributionRequest() {
        ...
        CalculateContributionDTO calculateContributionDTO =
                TestModelDataBuilder.getContributionDTOForCompareContributionService(
                        ...
                        null,
                        null,
                        TestModelDataBuilder.TEST_DATE.toLocalDate(),
                        null);
        ...
        softly.assertThat(request.getEffectiveDate().getDayOfMonth())
                .isEqualTo(TestModelDataBuilder.TEST_DATE.getDayOfMonth());
        ...
        softly.assertThat(request.getCalcDate().getDayOfMonth())
                .isEqualTo(TestModelDataBuilder.CALC_DATE.getDayOfMonth());
        softly.assertThat(request.getCalcDate().getYear()).isEqualTo(TestModelDataBuilder.CALC_DATE.getYear());
        softly.assertThat(request.getDateUpliftApplied().getYear())
                .isEqualTo(TestModelDataBuilder.UPLIFT_APPLIED_DATE.getYear());
        softly.assertThat(request.getDateUpliftApplied().getMonth())
                .isEqualTo(TestModelDataBuilder.UPLIFT_APPLIED_DATE.getMonth());
        softly.assertThat(request.getDateUpliftApplied().getDayOfMonth())
                .isEqualTo(TestModelDataBuilder.UPLIFT_APPLIED_DATE.getDayOfMonth());
        softly.assertThat(request.getDateUpliftRemoved().getYear())
                .isEqualTo(TestModelDataBuilder.UPLIFT_REMOVED_DATE.getYear());
        softly.assertThat(request.getDateUpliftRemoved().getMonth())
                .isEqualTo(TestModelDataBuilder.UPLIFT_REMOVED_DATE.getMonth());
        softly.assertThat(request.getDateUpliftRemoved().getDayOfMonth())
                .isEqualTo(TestModelDataBuilder.UPLIFT_REMOVED_DATE.getDayOfMonth());
        softly.assertAll();
    }
    ...
    void givenAValidContributionDTOAndResult_whenMapIsInvoked_thenReturnCreateContributionRequest() {
        ...
        softly.assertThat(request.getEffectiveDate().getMonth())
                .isEqualTo(LocalDateTime.now().getMonth());
        softly.assertThat(request.getEffectiveDate().getDayOfMonth())
                .isEqualTo(LocalDateTime.now().getDayOfMonth());
        softly.assertThat(request.getEffectiveDate().getYear())
                .isEqualTo(LocalDateTime.now().getYear());
