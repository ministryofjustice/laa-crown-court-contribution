...
class AppealContributionAmountTest {
    ...
    void givenASuccessfulAssessmentResult_thenZeroContributionAmountIsReturned(
            AppealType appealType, CrownCourtOutcome appealOutcome) {
        AppealContributionAmount result =
                AppealContributionAmount.calculate(appealType, appealOutcome, AssessmentResult.PASS);
    ...
    void givenAFailedAssessmentResultAndSuccessfulAppealOutcome_thenZeroContributionAmountIsReturned(
            AppealType appealType) {
        AppealContributionAmount result =
                AppealContributionAmount.calculate(appealType, CrownCourtOutcome.SUCCESSFUL, AssessmentResult.FAIL);
    ...
    void givenAppealTypeIsACNAndPartSuccessAppealOutcome_thenZeroCContributionIsReturned() {
        AppealContributionAmount result = AppealContributionAmount.calculate(
                AppealType.ACN, CrownCourtOutcome.PART_SUCCESS, AssessmentResult.FAIL);
    ...
    void givenAppealTypeIsASEAndPartSuccessAppealOutcome_thenZeroCContributionIsReturned() {
        AppealContributionAmount result = AppealContributionAmount.calculate(
                AppealType.ASE, CrownCourtOutcome.PART_SUCCESS, AssessmentResult.FAIL);
    ...
    void givenAppealTypeIsACSAndPartSuccessfulAppealOutcome_thenPartialContributionAmountIsReturned() {
        AppealContributionAmount result = AppealContributionAmount.calculate(
                AppealType.ACS, CrownCourtOutcome.PART_SUCCESS, AssessmentResult.FAIL);
    ...
    void givenAppealTypeIsASEAndUnsuccessfulAppealOutcome_thenPartialContributionAmountIsReturned() {
        AppealContributionAmount result = AppealContributionAmount.calculate(
                AppealType.ASE, CrownCourtOutcome.UNSUCCESSFUL, AssessmentResult.FAIL);
    ...
    void givenAppealTypeIsACNAndUnsuccessfulAppealOutcome_thenFullContributionAmountIsReturned() {
        AppealContributionAmount result = AppealContributionAmount.calculate(
                AppealType.ACN, CrownCourtOutcome.UNSUCCESSFUL, AssessmentResult.FAIL);
    ...
    void givenAppealTypeIsACSAndUnsuccessfulAppealOutcome_thenFullContributionAmountIsReturned() {
        AppealContributionAmount result = AppealContributionAmount.calculate(
                AppealType.ACS, CrownCourtOutcome.UNSUCCESSFUL, AssessmentResult.FAIL);
